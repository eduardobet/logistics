    ...
    public function genInvoice($request, $tenant)
    {
        ...
        $invoice = $this->invoice()->updateOrCreate(
            ...
            [
                ...
                'cubic_feet' => $request->total_cubic_feet ? $request->total_cubic_feet : 0,
                'total' => $request->total,
                'notes' => $request->notes,
        ...
        foreach ($details as $data) {
            ...
            $invoice->details()->updateOrCreate(['id' => $input->wdid, ], [
                ...
                'width' => $input->width,
                'height' => $input->height,
                'vol_weight' => $input->vol_weight ? $input->vol_weight : 0,
                'real_weight' => $input->real_weight ? $input->real_weight : 0,
