        ...
        <div class="row">
            ...
            <div class="col-10">
                <div class="form-group mg-b-10-force">
                    ...
                    {!! Form::select("invoice_detail[{$key}][type]",[1=>'Compras por internet',2=>'Comisión tarjeta', 3=>'Paquete',4=>'Caja/Peq.', 5=>'Caja/Med.', 6=>'Caja/Grande', ], $idetail->type, ['class' => 'form-control form-control-sm type', ]) !!}
                </div>
            </div>
        </div>
    </div>
