...
{{ __('Hello :who welcome to :what', ['who' => $employee->full_name, 'what' => $tenant->name ] ) }}. <br><br>{{ __('Please click the following link to activate your account.') }}: <a href="{{ URL::signedRoute('tenant.employee.get.unlock', [$tenant->domain,$employee->email, $employee->token]) }}">{{ route('tenant.employee.get.unlock', [$tenant->domain, $employee->email, $employee->token]) }}</a><br><br>
