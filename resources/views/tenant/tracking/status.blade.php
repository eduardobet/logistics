        ...
        <div class="card card-status">
            <div class="media align-self-center">
                <div class="text-center">
                    ...
                    <h4 class="tx-gray-300" id="first-title">{{ strtoupper(__('Origin')) }}</h4>
        ...
        <div class="card card-status">
            <div class="media align-self-center">
                <div class="text-center">
                    ...
                    <h4 class="tx-gray-300" id="second-title">{{ strtoupper(__('Shipped')) }}</h4>
        ...
        <div class="card card-status">
            <div class="media align-self-center">
                <div class="text-center">
                    ...
                    <p class="tx-gray-300" id="fourth-description">{{ __('Available for pickup') }}</p>
