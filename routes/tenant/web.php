...
Route::group(['domain' => '{domain}', 'middleware' => 'tenant'], function () {
    ...
    Route::get('malidentificados/list', 'Tenant\MisidentifiedController@index')->name('tenant.misidentified-package.index')
        ->middleware(['auth', 'can:show-misreca']);
    Route::get('malidentificados/{id}/show', 'Tenant\MisidentifiedController@show')->name('tenant.misidentified-package.show')->middleware(['auth', 'can:show-misreca']);
    Route::get('malidentificados', 'Tenant\MisidentifiedController@create')->name('tenant.misidentified-package.create')->middleware(['auth', 'can:create-misreca']);
